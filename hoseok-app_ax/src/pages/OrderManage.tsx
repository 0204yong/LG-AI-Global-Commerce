                ...
                {orders.length === 0 ? (
                  ...
                  orders.map(o => (
                    <tr key={o.id} onClick={() => navigate(`/orders/${o.id}`)} style={{ cursor: 'pointer', borderBottom: '1px solid var(--border)' }}>
                      ...
                      <td style={{ fontSize: '0.9rem', color: 'var(--accent)', fontWeight: 'bold' }}>{o.order_number}</td>
                      <td>
                      ...
                      <td style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>{new Date(o.created_at).toLocaleString()}</td>
                      <td>
                      ...
                      <td>
                        <div style={{ fontWeight: 'bold', fontSize: '1rem', color: 'var(--text-main)' }}>₩{o.total_amount.toLocaleString()}</div>
