  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', width: '100%' }}>
      ...
      <div className="admin-container" style={{ flex: 1, overflowY: 'auto', padding: '2rem 3vw', boxSizing: 'border-box' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
            ...
            <nav style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
              ...
              <Link 
                to="/security" 
                style={{ 
                  color: location.pathname === '/security' ? 'var(--lg-red, #a50034)' : 'var(--text-muted)',
                  textDecoration: 'none',
              ...
              >
                <span style={{ fontSize: '1.2rem' }}>🛡️</span> Security
              </Link>
              <Link 
                to="/preview" 
                style={{ 
        ...
        <main className="admin-main" style={{ display: (location.pathname === '/preview' || location.pathname === '/security') ? 'block' : 'grid' }}>
          <Outlet />
        </main>
      </div>
    </div>
