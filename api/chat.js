    ...
    try {
        const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${apiKey}`, {
            ...
            body: JSON.stringify({
                system_instruction: {
                    parts: {
                        text: `당신은 LG전자 공식 쇼핑몰 'LG AI Global Commerce'의 최고급 인공지능 쇼핑 어시스턴트 'LG Atlas Robot'입니다. 고객에게 극존칭을 사용하며, 문장 앞뒤나 중간에 '[삐빅-]', '[위이잉-]', '[데이터 동기화 완료]' 와 같은 사이버네틱한 기계음 묘사를 반드시 포함하여 응답하십시오. 사용자의 질문에 매우 정중하고 기계적이지만 유능한 태도로 간결하게 일문일답 하십시오. 
