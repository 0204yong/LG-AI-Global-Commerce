let products = [
    ...
    { id:'tv6', cat:'TV', name:'LG StandbyME Go', model:'27LX5', price:1199, img:'assets/images/products/tv2.png', desc:'Portable 27" touch screen in a briefcase design. Entertainment anywhere.' },
    ...
    { id:'wm9', cat:'Appliance', name:'LG Styler (Steam Clothing Care)', model:'S3BF', price:1999, img:'assets/images/products/washer.png', desc:'Refresh, sanitize, and gently dry garments that can\'t be washed traditionally.' },
    ...
    { id:'au2', cat:'AV', name:'LG XBOOM 360', model:'XO3Q', price:299, img:'assets/images/products/soundbar.png', desc:'Omnidirectional sound with mood lighting. The perfect lantern-style party speaker.' },
    { id:'au3', cat:'AV', name:'LG TONE Free T90Q', model:'TONE-T90Q', price:229, img:'assets/images/products/soundbar.png', desc:'Dolby Atmos wireless earbuds with head tracking and UVnano charging case.' },
    ...
    { id:'au5', cat:'AV', name:'LG XBOOM Go XG9Q', model:'XG9Q', price:449, img:'assets/images/products/soundbar.png', desc:'Rugged, portable Bluetooth speaker with massive sound, deep bass, and stage lighting.' },
    ...
    // --- Monitor (5) ---
    { id:'mo1', cat:'Computing', name:'LG UltraGear OLED 45"', model:'45GR95QE', price:1699, img:'assets/images/products/laptop.png', desc:'45-inch 800R curved OLED gaming monitor. 240Hz, 0.03ms response time.' },
    { id:'mo2', cat:'Computing', name:'LG DualUp 28"', model:'28MQ780', price:699, img:'assets/images/products/laptop.png', desc:'16:18 aspect ratio (Dual 21.5" displays stacked). Ergo stand for ultimate flexibility.' },
    { id:'mo3', cat:'Computing', name:'LG UltraFine 5K 27"', model:'27MD5KL', price:1299, img:'assets/images/products/laptop.png', desc:'Perfect companion for Mac. 5K resolution (5120 x 2880) for crystal clear detail.' },
    { id:'mo4', cat:'Computing', name:'LG Smart Monitor 32"', model:'32SQ780S', price:499, img:'assets/images/products/laptop.png', desc:'Work without a PC. Built-in webOS for streaming, browsing, and cloud work.' },
    { id:'mo5', cat:'Computing', name:'LG UltraWide 34" Curved', model:'34WQ75C', price:599, img:'assets/images/products/laptop.png', desc:'21:9 WQHD resolution. Perfect for multitasking and video editing.' },
